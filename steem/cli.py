...
def legacyentry():
    ...
    """
        create_proposal
    """
    parser_createproposal = subparsers.add_parser('createproposal', 
        help = 'Create new proposal for Steem Proposal System')
    parser_createproposal.set_defaults(command = 'createproposal')
    parser_createproposal.add_argument('creator', type = str, 
        help = 'Creator name')
    parser_createproposal.add_argument('receiver', type = str, 
        help = 'Receiver name')
    parser_createproposal.add_argument('start_date', type = str, 
        help = 'Start date for proposal')
    parser_createproposal.add_argument('end_date', type = str, 
        help = 'End date of proposa')
    parser_createproposal.add_argument('daily_pay', type = str, 
    ...
    """
    parser_updateproposalvotes = subparsers.add_parser('updateproposalvotes', 
        help = 'Enables voting for chosen proposals')
    parser_updateproposalvotes.set_defaults(command = 'updateproposalvotes')
    parser_updateproposalvotes.add_argument('voter', type = str, 
        help = 'Voter name')
    parser_updateproposalvotes.add_argument('proposal_ids', type = int, 
        nargs = '*', help = 'List of proposal ids to vote')
    parser_updateproposalvotes.add_argument('approve', type = bool, 
        help = 'Approve proposals given with ids')
    ...
    parser_removeproposal.add_argument('proposal_ids', type = int, nargs = '*', 
        help = 'List of proposal ids to vote')

    """
        find_proposals
    """
    parser_findproposals = subparsers.add_parser('findproposals', 
        help = 'List proposals with given ids')
    parser_findproposals.set_defaults(command = 'findproposals')
    parser_findproposals.add_argument('proposal_ids', type = int, nargs = '*', 
        help = 'List of proposal ids to find')

    """
        list_proposals
    """
    parser_listproposals = subparsers.add_parser('listproposals', 
        help = 'List proposals based on search criterias')
    parser_listproposals.set_defaults(command = 'listproposals')
    parser_listproposals.add_argument('start', type = str, 
    ...
    if args.command == "set":
        ...
        print_json(steem.commit.create_proposal(
            args.creator, 
            args.receiver, 
            args.start_date, 
            args.end_date, 
        ...
        print_json(steem.commit.remove_proposal(
            args.proposal_owner, 
            args.proposal_ids))
